 ...
 */
#define MY_DEFAULT_HOST_NAME			"DMXKITTY"
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE				(10684ul)
...
// -- SSL Options --------------------------------------------------------
	...
	#define MAX_SSL_CONNECTIONS		(0ul)	// Maximum connections via SSL
	#define MAX_SSL_SESSIONS		(0ul)	// Max # of cached SSL sessions
